...
<body>
    ...
    <form>
        <table style="border: 2px solid black; width: 40%;" align="center">
            ...
            <tr><td>ชื่อบัญชี:</td><td><input type="text" name="user" size="40" required></td></tr>
            <tr><td>รหัสผ่าน:</td><td><input type="password" name="pwd" size="40" required></td></tr>
            <tr><td>ชือ-นามสกุล:</td><td><input type="text" name="name" size="40" required></td></tr>
            <tr><td>เพศ:</td>
                <td>
            ...
            <tr><td>อีเมล:</td><td><input type="text" name="mail" size="40" required></td></tr>
