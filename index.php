...
<head>
    ...
    <title>Webboard GungGing</title>
</head>
<body>
    <div class="container-lg">
    <h1 style="text-align: center;" class="mt-3">Webboard GungGing</h1>
<?php include "nav.php" ?>
  ...
  <?php
        for($i=1;$i<=10;$i++){
            ...
            if(isset($_SESSION['id']) && $_SESSION['role']=='a'){
                echo "&nbsp;&nbsp;<a href=delete.php?id=$i class='btn btn-danger btn-sm'><i class='bi bi-trash-fill'></i></a>";
            }
            echo "</td></tr>";
        }
        ?>
